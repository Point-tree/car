...
export default log4js.connectLogger(log4js.getLogger(), { level: "auto", format:(req, res, format) => {
  return format(`:user-agent | :remote-addr | :response-time | :method | :status | :url | {req_data:${JSON.stringify({query:req.query,body:req.body,params:req.params})}, headers:${JSON.stringify(req.headers)}}}`)
}});
